...
def dissimilaritydrive_global_balanced_cluster_split(data, targets, threads=24, sizes = [80,10,10]):
    ...
    for i, target in enumerate(targets):
        print(f'calculating data per cluster for target {target} - num {i}')
