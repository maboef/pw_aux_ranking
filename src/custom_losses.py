...
from py_boost.gpu.losses.metrics import metric_alias, RMSEMetric, RMSLEMetric, BCEMetric
from py_boost.gpu.losses.multiclass_metrics import multiclass_metric_alias, CrossEntropyMetric
